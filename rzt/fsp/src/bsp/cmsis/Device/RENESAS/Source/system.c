 ...
 **********************************************************************************************************************/
 ...
 #define BSP_PRV_M_MPU_REGION_NUM    (7)
  ...
  #define BSP_PRV_SECTION_USER_PRG_RAM_END                     __section_end("USER_PRG_WBLOCK")
    ...
    #define BSP_PRV_SECTION_MY_PRG_ROM_ADDRESS                 __section_begin("USER_MY_RBLOCK")
  #define BSP_PRV_SECTION_MY_PRG_RAM_START                   __section_begin("USER_MY_PRG")
  #define BSP_PRV_SECTION_MY_PRG_RAM_END                     __section_end("USER_MY_PRG")
...
//  #define BSP_PRV_SECTION_MY_PRG_RAM_END                     __section_end("USER_MY_PRG")
  ...
  #pragma section="USER_MY_RBLOCK"
  #pragma section="USER_MY_PRG"
...
//  #define BSP_PRV_SECTION_MY_PRG_RAM_END                     __section_end("USER_MY_PRG")
    ...
    src  = (uint32_t *) BSP_PRV_SECTION_MY_PRG_ROM_ADDRESS;
    dst  = (uint32_t *) BSP_PRV_SECTION_MY_PRG_RAM_START;
    size = (uint32_t) BSP_PRV_SECTION_MY_PRG_RAM_END - (uint32_t) BSP_PRV_SECTION_MY_PRG_RAM_START;
    bsp_copy_4byte(src, dst, size);
